...
if(isset($_GET['userid'])){
  $identuser=$_GET['userid'];
  $identusb=$_GET['identusb'];

  $db = new PDO("mysql:host=localhost;dbname=$database", $user, $password);
  $db->query("UPDATE $table SET userFOR='$identuser' WHERE id=$identusb");
}

?>
<!doctype html>
<html lang="en" data-bs-theme="auto">
  <head><script src="docs/5.3/dist/js/color-modes.js"></script>
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">ANTIVIRUS-VT</a>
  ...
  <div class="navbar-nav">
    <div class="nav-item text-nowrap">
      <a class="nav-link px-3" href="../sign-in.html">Sign out</a>
    </div>
  </div>
</header>
  ...
  <div class="row">
    ...
    echo"<main class='col-md-9 ms-sm-auto col-lg-10 px-md-4'>
      <div class='d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom'>
        <h1 class='h2'>"<div class="1idusb"></div>."</h1>
